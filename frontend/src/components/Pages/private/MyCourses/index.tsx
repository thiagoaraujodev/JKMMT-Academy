...
const MyCourses: React.FC<IPropsStyled> = ({ className }) => {
	return (
		<>
			<HeaderPrivate />
			<main className={className}>
				<div className="container flex">
					...
					<div className="contents">
						...
						<p>
							Não encontramos nenhum curso em sua conta. Inscreva-se em um novo curso e comece sua rotina de estudos
							diários!
						</p>
					</div>
				</div>
...
export default styled(MyCourses)`
	margin-top: 80px;
